 ...
 */
export function balanceToString(value, coinDecimals) {
    if (value === 0n) {
        return "0";
    }
 ...
 */
export function stringToBalance(value, coinDecimals) {
    value = value.trim();
    if (["", ".", "-"].includes(value)) {
        return 0n;
    }
 ...
 */
export function formatNumber(num, format = "standard") {
    if (format === "standard") {
 ...
 *   - If the number is >= 1 million, use word notation (e.g. '540.23M', '20.05B')
 */
export function formatBalance(big, decimals, format = "standard") {
