...
class SuiClientBase {
    ...
    async fetchAndParseObjs({ ids, fetchFn, parseFn, cache, }) {
        ...
        const idChunks = (0, misc_js_1.chunkArray)(uncachedIds, MAX_OBJECTS_PER_REQUEST);
        ...
        for (const resps of allResults) {
            for (const resp of resps) {
                ...
                if (parsedObject) {
                    ...
                    if (cache) {
                        cache.set((0, objects_js_1.objResToId)(resp), parsedObject);
                    }
                }
            }
        }
...
exports.SuiClientBase = SuiClientBase;
