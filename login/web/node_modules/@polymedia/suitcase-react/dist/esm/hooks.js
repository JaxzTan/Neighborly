 ...
 */
export function useClickOutside(domElementRef, onClickOutside) {
 ...
 */
export function useFetchAndLoadMore(fetchFunction, dependencies = []) {
 ...
 */
export function useFetchAndPaginate(fetchFunction, dependencies = []) {
