    ...
    return {
      objects: options.objectIds.map((id) => normalizeSuiAddress(id)).map(
        ...
        return {
          ...
          content: obj.asMoveObject ? fromBase64((_e = (_d = obj.asMoveObject) == null ? void 0 : _d.contents) == null ? void 0 : _e.bcs) : new Uint8Array()
        };
      })
    };
  }
    ...
    return {
      objects: objects.nodes.map((obj) => {
        ...
        return {
          ...
          content: fromBase64((_c = obj.contents) == null ? void 0 : _c.bcs)
        };
      }),
    ...
    return {
      ...
      objects: coins.nodes.map((coin) => {
        ...
        return {
          ...
          content: fromBase64((_c = coin.contents) == null ? void 0 : _c.bcs)
        };
      })
    };
  }
...
function mapOwner(owner) {
  ...
  switch (owner.__typename) {
    ...
    case "Parent":
      return { $kind: "ObjectOwner", ObjectOwner: (_c = owner.parent) == null ? void 0 : _c.address };
    case "Shared":
...
//# sourceMappingURL=chunk-PTBBFSUW.js.map
