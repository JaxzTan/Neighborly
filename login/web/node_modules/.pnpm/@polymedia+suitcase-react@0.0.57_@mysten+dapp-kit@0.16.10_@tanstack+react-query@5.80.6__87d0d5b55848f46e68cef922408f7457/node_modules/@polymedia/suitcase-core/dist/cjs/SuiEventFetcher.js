...
exports.SuiEventFetcher = void 0;
...
class SuiEventFetcher {
    ...
    eventCursor;
    suiClient;
    rateLimitDelay = 300; // how long to sleep between RPC requests, in milliseconds
    /**
    ...
    async fetchEventsFromCursor() {
        ...
        if (suiEvents.hasNextPage) {
            ...
            await (0, misc_js_1.sleep)(this.rateLimitDelay);
...
exports.SuiEventFetcher = SuiEventFetcher;
