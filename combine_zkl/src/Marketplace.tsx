      ...
      <div className="phone-frame">
        <div className="phone-screen bg-[#556072] text-white p-4 font-serif">
          ...
          <div className="relative flex items-center mb-4">
            ...
            <h1 className="title_marketplace mx-2">Marketplace</h1>
            <img
              src="messenger.png"
              alt="messenger logo"
          ...
          <div className="px-4 mb-4">
            ...
            <div className="flex_box_marketplace flex gap-2">
              {[1, 2, 3].map((i) => (
          ...
          {/* Sell Items */}
          <div className="p-4">
            <button className="sell-button flex items-center gap-2">
              <img
                src="/camera.png"
                alt="camera icon"
          ...
          {/* Advertisements */}
          <div className="advertisement-container mb-4">
