...
export declare class SuiMultiClient {
     ...
     */
    executeInBatches<InputType, OutputType>(inputs: InputType[], operation: (client: SuiClientWithEndpoint, input: InputType) => Promise<OutputType>, onUpdate?: (msg: string) => unknown): Promise<OutputType[]>;
    /**
