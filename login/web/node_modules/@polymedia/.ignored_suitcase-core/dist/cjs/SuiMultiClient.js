...
exports.SuiMultiClient = void 0;
const client_1 = require("@mysten/sui/client");
const misc_js_1 = require("./misc.js");
const rpcs_js_1 = require("./rpcs.js");
/**
...
class SuiMultiClient {
    ...
    constructor(endpointUrls, rateLimitDelay = 300) {
        ...
        for (const endpoint of endpoints) {
            const client = new client_1.SuiClient({ url: endpoint });
    ...
    static newWithDefaultEndpoints(network, rateLimitDelay) {
        const endpoints = rpcs_js_1.RPC_ENDPOINTS[network];
    ...
    async executeInBatches(inputs, operation, onUpdate) {
        ...
        for (let start = 0, batchNum = 1; start < inputs.length; start += batchSize, batchNum++) {
            ...
            if (timeTaken < this.rateLimitDelay) {
                await (0, misc_js_1.sleep)(this.rateLimitDelay - timeTaken);
            }
        }
...
exports.SuiMultiClient = SuiMultiClient;
